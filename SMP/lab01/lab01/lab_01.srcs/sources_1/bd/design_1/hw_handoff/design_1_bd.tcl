...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_pins core_logic_0/trdy] [get_bd_pins graphic_controller_0/trdy]
  connect_bd_net -net Net1 [get_bd_pins core_logic_0/irdy] [get_bd_pins graphic_controller_0/irdy]
  connect_bd_net -net Net3 [get_bd_pins core_logic_0/c_be] [get_bd_pins graphic_controller_0/c_be]
  connect_bd_net -net Net4 [get_bd_pins core_logic_0/ad] [get_bd_pins graphic_controller_0/ad]
  connect_bd_net -net Net5 [get_bd_pins core_logic_0/rst] [get_bd_pins graphic_controller_0/rst]
  connect_bd_net -net Net6 [get_bd_pins core_logic_0/ad_stb1] [get_bd_pins graphic_controller_0/ad_stb1]
  connect_bd_net -net Net7 [get_bd_pins core_logic_0/ad_stb0] [get_bd_pins graphic_controller_0/ad_stb0]
