...
#
# Generated by export_simulation on Wed Jan 13 14:50:03 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './PICtoSRAM.sh' script.

./PICtoSRAM.sh -reset_run
...
./PICtoSRAM.sh -noclean_files

For more information on the script, please type './PICtoSRAM.sh -help'.
